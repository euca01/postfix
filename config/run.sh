...
add_config_value "smtp_tls_chain_files" "/etc/postfix/tls-ECDSA/${DOMAINSSL}_ECDSA-P-256.key, /etc/postfix/tls-ECDSA/${DOMAINSSL}_ECDSA-P-256.crt, /etc/postfix/tls/${DOMAINSSL}_RSA.key, /etc/postfix/tls/${DOMAINSSL}_RSA.crt"
